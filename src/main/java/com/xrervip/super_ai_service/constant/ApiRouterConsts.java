...
public class ApiRouterConsts {
     ...
     * 前台门户模型相关API请求路径前缀
     */
    public static final String API_FRONT_MODEL_URL_PREFIX = API_FRONT_URL_PREFIX + MODEL_URL_PREFIX;

    /**
     * 前台门户图像相关API请求路径前缀
     */
    public static final String API_FRONT_IMAGE_URL_PREFIX = API_FRONT_URL_PREFIX + IMAGE_URL_PREFIX;
